...
CREATE TABLE `contract` (
  ...
  CONSTRAINT `id_customer_fk` FOREIGN KEY (`id_customer`) REFERENCES `customers` (`id`),
...
CREATE TABLE `properties` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_customers_fk` (`id_customer`),
  CONSTRAINT `id_customers_fk` FOREIGN KEY (`id_customer`) REFERENCES `customers` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-11-14 10:04:28
